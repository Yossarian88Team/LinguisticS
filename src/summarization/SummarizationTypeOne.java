 ...
 * @author Ariel
 */
public class SummarizationTypeOne {
    
    private String summarizationText=null;
    private QuantifierTypeOne quantifier=null;
    ...
    public SummarizationTypeOne(QuantifierTypeOne quantifier, SummarizerInterface summarizer, List<PlayerStat> playerStat)
    {
    ...
    public SummarizationTypeOne(QuantifierTypeOne quantifier, SummarizerInterface summarizer, QualifierInterface qualifier, List<PlayerStat> playerStat)
    {
        this.quantifier=quantifier;
        this.summarizer=summarizer;
        this.playerStat=playerStat;
    ...
    public QuantifierTypeOne getQuantifier() {
        return quantifier;
    }

    public void setQuantifier(QuantifierTypeOne quantifier) {
        this.quantifier = quantifier;
    }
