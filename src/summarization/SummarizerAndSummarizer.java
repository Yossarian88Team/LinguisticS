 ...
 * @author Ariel
 */
public class SummarizerAndSummarizer implements SummarizerInterface {
    ...
    public SummarizerAndSummarizer( SummarizerInterface summarizerFirst, SummarizerInterface summarizerSecond){
    ...
    public String getSummarizerLabel(){
        ...
        return this.summarizerFirst.getSummarizerLabel() + " i " + this.summarizerSecond.getSummarizerLabel();
    }
    ...
    public String getColumnName(){
        return summarizerFirst.getColumnName() + "i" + summarizerSecond.getColumnName();
        
    }
    
    public double getMembershipValue(double key){
        return Math.min(summarizerFirst.getMembershipValue(key), summarizerSecond.getMembershipValue(key));
    }
    ...
    public String toString(){
	  return summarizerFirst.getLabel() + "i" + summarizerSecond.getLabel();
     }

    public String getLabel() {
        return summarizerFirst.getSummarizerLabel() + "i" + summarizerSecond.getSummarizerLabel();
    }
