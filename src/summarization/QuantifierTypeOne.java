 ...
 * @author Ariel
 */
public class QuantifierTypeOne {
    
    private LinguisticValueTypeOne lingValue=null;
    public enum QuantifierType { RELATIVE, ABSOLUTE };
    private QuantifierType type=null;
    
    public QuantifierTypeOne(LinguisticValueTypeOne lingValue, boolean relative)
    {
    ...
    public LinguisticValueTypeOne getLingValue() {
        return lingValue;
    }
    ...
    public void setLingValue(LinguisticValueTypeOne lingValue) {
        this.lingValue = lingValue;
    }
    ...
    private List<double[]> getValuesToHistogram()
    {
        ...
        double start=lingValue.getSet().getFspace().getStart();
        double end=lingValue.getSet().getFspace().getEnd();
        double step=lingValue.getSet().getFspace().getStep();
